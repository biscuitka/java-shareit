...
public interface BookingService {
    ...
    List<BookingDtoOut> getAllBookingByUser(long userId, StateOfBooking stateOfBooking);

    List<BookingDtoOut> getAllBookingsByItemOwner(long userId, StateOfBooking stateOfBooking);
}